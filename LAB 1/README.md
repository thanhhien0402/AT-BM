...
Các máy được cấu hình trong cùng một mạng ảo để thực hiện kết nối và trao đổi dữ liệu.
...
Trong bài Lab đã thực hiện các nội dung chính:
...
Trong quá trình thực hiện có thể gặp một số vấn đề như:



\- Client không kết nối được với Server do cấu hình mạng chưa phù hợp.

\- Không kết nối được Telnet/SSH do dịch vụ chưa hoạt động.

\- Wireshark không bắt được lưu lượng do chọn sai Network Interface.
